    ...
    const handleProcessRecon = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                alert(`Recon process requested successfully: ${result}`);
                fetchStatus();
            } else {
        ...
        <div className="flex flex-col min-h-screen p-6 bg-[#f8fbff] text-[#333]">
           <div className="bg-white shadow-sm rounded-md p-10 mb-8 max-w-3xl mx-auto w-full border border-gray-100 flex flex-col items-center">
               ...
               <div className="flex items-center justify-center w-full max-w-lg mb-8">
                   ...
                   <div className="w-2/3">
                       <select 
                           className="w-full border border-gray-300 rounded px-4 py-2 outline-none focus:ring-2 focus:ring-[#2b65ba] bg-white"
                           value={selectedGroup}
               ...
               <button 
                   ...
                   className={`bg-[#1c64c7] text-white px-8 py-3 rounded font-bold text-lg shadow hover:bg-blue-800 transition w-72 ${(!selectedGroup || processing) ? 'opacity-50 cursor-not-allowed' : ''}`}
               >
                           ...
                           statusData.map((row) => (
                               <tr key={row.id} className="hover:bg-gray-50">
                                   ...
                                   <td className="px-5 py-4">
                                       <button className="bg-[#1c64c7] text-white px-4 py-1.5 rounded text-sm font-semibold hover:bg-blue-800 shadow-sm">
                                            Rerun
                                       </button>
                                   </td>
                               </tr>
